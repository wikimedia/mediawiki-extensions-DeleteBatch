 ...
 */
$messages['fa'] = array(
	'deletebatch' => 'حذف گروهی از صفحات',
	'deletebatch-desc' => '[[Special:DeleteBatch|Delete a batch of pages]]',
	'deletebatch-help' => 'گروهی از صفحات را حذف کنید.
شما می توانید یا تنها یک حذف انجام دهید، یا صفحات فهرست شده در یک پوشه را حذف کنید.
کاربری را که در سیاهه‌های حذف نمایش خواهد داده شد را انتخاب کنید.
پوشه‌های انتقال داده شده باید شامل نام صفحه و دلیل اختیاری، توسط یک خصیصهٔ "|" در هر خط جدا شده باشد.',
	'deletebatch-caption' => 'فهرست صفحه:',
	'deletebatch-title' => 'حذف انبوه',
	'deletebatch-link-back' => 'بازگشت به صفحه ویژه',
	'deletebatch-as' => 'اجرای متن به عنوان:',
	'deletebatch-both-modes' => 'لطفاً یا یک صفحهٔ تعیین شده یا فهرست صفحات داده شده را انتخاب کنید.',
	'deletebatch-or' => '<strong>یا</strong>',
	'deletebatch-delete' => 'حذف',
	'deletebatch-page' => 'صفحه‌هایی که باید حذف شوند:',
	'deletebatch-processing-from-file' => 'حذف صفحات فهرست شده در پوشه',
	'deletebatch-processing-from-form' => 'حذف صفحات فهرست شده در فرم',
	'deletebatch-omitting-nonexistent' => 'حذف صفحهٔ غیر‌موجود $1',
	'deletebatch-omitting-invalid' => 'حذف صفحهٔ نامعتبر $1',
	'deletebatch-file-bad-format' => 'پوشه باید متن واضح باشد.',
	'deletebatch-file-missing' => 'قادر به خواندن پوشهٔ داده شده نیست.',
	'deletebatch-select-script' => 'حذف متن صفحه',
	'deletebatch-select-yourself' => 'شما',
	'deletebatch-no-page' => 'لطفاً حداقل یک صفحه برای حذف کردن تعیین کنید یا یک پوشه شامل فهرست صفحه انتخاب کنید.',
	'right-deletebatch' => 'گروه صفحات حذفی',
	'deletebatch-deleting-file-only' => 'صفحهٔ توصیف پوشهٔ $1 وجود ندارد؛ فقط حذف پوشهٔ حقیقی وجود دارد.
این عمل وارد نخواهد شد.',
);
...
올린 파일은 각 라인의 문자에 "|"로 구분하여 문서 이름과 선택적인 이유가 있어야 합니다.',
	...
	'deletebatch-page' => '삭제될 문서:',
	'deletebatch-processing-from-file' => '파일에 나열된 문서를 삭제 중',
	'deletebatch-processing-from-form' => '양식에 나열된 문서를 삭제 중',
	'deletebatch-omitting-nonexistent' => '존재하지 않는 $1 문서는 생략합니다.',
	'deletebatch-omitting-invalid' => '잘못된 $1 문서는 생략합니다.',
	'deletebatch-file-bad-format' => '파일은 일반 텍스트이여야 합니다',
	'deletebatch-file-missing' => '주어진 파일을 읽을 수 없습니다.',
